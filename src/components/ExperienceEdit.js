...
const ExperienceEdit = (props) => {
  ...
  const [fields, setFieldsEdit] = useState(experienceField);

  useState(
    (res) => {
      console.log("edit experience", props.experienceField);
      setFieldsEdit(props.experienceField);
    },
    [editFormId]
  );
